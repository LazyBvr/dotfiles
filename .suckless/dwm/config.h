...
static const char *fonts[]          = { "terminus:size=10", "material icons:size=11" };
...
/* tagging */
static const char *tags[] = { "MAIN", "CODE", "DOCS", "MULT", "GAME", "MISC"};
...
static Key keys[] = {
  ...
  { 0,                            XF86XK_AudioLowerVolume,  spawn,         {.v = voldowncmd} },
	{ MODKEY|ShiftMask,             XK_e,      spawn,          {.v = shutdowncmd} },
